		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 project-details">
					<img id="project-loader" src="<?php echo get_stylesheet_directory_uri(); ?>/images/loader.gif" alt=""/>
					<div class="project-content"></div>

					<div class="project-close"><a class="btn-style-1">Close</a></div>
				</div>
			</div>
		</div>
	</div><!--end projectWrap -->
				...
				<div class="shot-wrap">
					...
					<div class="shot-more">
						...
						<div class="view-project">
							<a class="btn-style-1" href="<?php the_permalink(); ?>" ><?php _e('View More', 'match')?></a>
						</div>
					</div><!--end .shot-more-->
